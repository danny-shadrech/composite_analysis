...
ds = xr.open_dataset('/Users/dsha0113/Documents/PhD_Work/Data_Analysis/Netcdf_data/skj_adult_1998_2019.nc', decode_times=False)
time = pd.date_range('1998-01-15', periods=ds.sizes['time'], freq='MS') + pd.Timedelta(days=15)
...
lanina_years = [1999, 2000, 2007, 2008, 2010, 2011,2016, 2017]
elnino_years = [2002, 2004, 2006, 2009, 2014,2015,2018]
...
fig1.suptitle('Composite: Adult Skip-Jack tuna total biomass anomaly mean distribution during La Niña life cycle', fontsize=14, fontweight='semibold')
...
# Add a main figure title and reserve space at top
fig2.suptitle('Composite: Adult Skip-Jack tuna total biomass anomaly mean distribution during El Niño life cycle', fontsize=14, fontweight='semibold')
# Increase vertical spacing between subplots
